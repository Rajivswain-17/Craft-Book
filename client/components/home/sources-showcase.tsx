...
const SOURCE_FEATURES = [
  {
    ...
    description:
      "Upload multi-page research papers, slide decks, legal briefs, and textbooks. BookCraft parses and chunks the text, generating dense embeddings for sub-second retrieval.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Paste any YouTube video or lecture URL. BookCraft automatically pulls the complete closed captions and timestamps, allowing you to ask questions about spoken lectures.",
    highlights: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Eliminate AI hallucinations. BookCraft connects directly to your verified materials
