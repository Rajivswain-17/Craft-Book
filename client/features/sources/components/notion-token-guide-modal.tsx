        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                ...
                and click <strong>&quot;+ New integration&quot;</strong>. Name it <em>BookCraft</em>.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                In Notion, open any page you want to access, click the top-right <strong>···</strong> menu ➔ <strong>Connections</strong> ➔ select <em>BookCraft</em>.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Under <strong>Secrets</strong>, copy the <strong>Internal Integration Secret</strong> (starts with <code className="font-mono bg-muted px-1 py-0.5 rounded text-[10px]">secret_...</code>) and paste it into BookCraft.
              </p>
            </div>
          </div>
        </div>
