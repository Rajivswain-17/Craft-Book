...
export async function exportArtifactToNotion({
    ...
    if (content.markdown) {
        ...
        textToExport = `Artifact created by BookCraft AI.`;
    }
                ...
                rich_text: [
                    {
                        type: "text",
                        text: {
                            content: `⚡ Synthesized by BookCraft AI · Artifact Type: ${artifact.type}`,
                        },
                    },
                ],
            ...
            properties: {
                title: {
                    title: [
                        {
                            type: "text",
                            text: { content: artifact.title || "BookCraft Synthesis" },
                        },
                    ],
                },
            },
